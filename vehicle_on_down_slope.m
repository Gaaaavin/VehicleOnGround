...
friction_coef = tan(slope_angle);  % coefficient of friction of the ground(m^-1)
...
save("positions.mat", "wheels_positions", "body_positions", "body_velocitys", "timestep", "save_every")
