...
position_cm_wheels = [body_len, body_len, -body_len, -body_len;
       ...
       4.155, 3.082, 4.155, 3.082];  % initial position of centers of mass of wheels
position_cm_body = [0; 0; 3.618]; % initial position of center of mass of body
...
angular_velocity_wheels = repmat([0; 4.472; 2.236], 1, 4); % initial angular velocity of wheels
angular_velocity_body = [0; 0; 0];

cone_slope = 0.5;
cone_theta = atan(cone_slope);
...
position_tilde_wheels = wheels(rin_radius, num_rin_points, cone_theta);
position_tilde_body = body(body_len, body_wid, axle_len, cone_slope);
